...
public:
    ...
    // Проверка динамиков из настроек. Тот же пул, то есть ВЫБРАННОЕ устройство
    // вывода — ровно это человек и хочет услышать, нажимая «Проверить»: те ли
    // наушники. Правила play() здесь не действуют: выключенные звуки
    // интерфейса и снятый звук конференции не отменяют явной просьбы.
