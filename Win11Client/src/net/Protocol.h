...
namespace Proto {
    ...
    enum : quint8 {
        ...
        CODEC_HEVC = 5,
        // AV1. Безроялтийный по замыслу — единственный из современных, который
        // не перекладывает лицензионный вопрос на того, кто развернёт проект.
        // Упакован не как H.264/HEVC: там Annex B со стартовыми кодами, здесь
        // OBU. Приёмнику это безразлично (FFmpeg разбирает сам), а вот вебу
        // при добавлении понадобится строка вида av01.*, а не avc1.*.
        CODEC_AV1 = 6,
    };
