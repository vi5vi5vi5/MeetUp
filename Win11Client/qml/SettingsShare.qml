...
Column {
    ...
    Field {
        ...
        readonly property var hints: ({
            "auto": "Начинаем с H.264, при неудаче VP8. Так вас увидят и в браузере, и в старом клиенте.",
            "h264": "Дёшев по процессору, понимают все. На мелком шрифте мылит сильнее прочих.",
            "vp8":  "Запасной вариант там, где H.264 нет. Текст читается хуже, чем у VP9.",
            "vp9":  "Чище всех рисует мелкий шрифт и графики при том же канале. Заметно грузит процессор: на слабой машине просядет частота кадров.",
