...
const PATHS = {
  ...
  // Добавлено руками (Lucide "image") для вложений в чате конференции.
  image: [["rect", {
    x: 3,
    y: 3,
    width: 18,
  ...
  // Добавлено руками (Lucide "paperclip") — кнопка вложения в чате.
  paperclip: [["path", {
    d: "m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57A4 4 0 1 1 18 8.84l-8.59 8.57a2 2 0 0 1-2.83-2.83l8.49-8.48"
  }]],
  // --- Добавлено вручную поверх сборки Claude Design (Э3) ---
  // Lucide volume-2 / volume-x / maximize / minimize. Нужны доку
  // («общий звук»), личной громкости участника и полноэкранной
  // демонстрации. Если бандл будут пересобирать из дизайн-системы —
  // эти четыре записи надо вернуть.
  volume: [["polygon", {
  ...
  // Разделы настроек (Lucide lock / keyboard / activity / layout / info).
  lock: [["rect", {
